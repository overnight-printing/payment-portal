    ...
    html: `
      <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; border: 1px solid #e2e1e8; border-radius: 16px; background-color: #ffffff; color: #1f2937;">
        ...
        <div style="text-align: center; margin: 32px 0;">
          <a href="${paymentLinkUrl}" style="background-color: #6d28d9; color: #ffffff; padding: 14px 28px; text-decoration: none; font-weight: 600; font-size: 16px; border-radius: 10px; display: inline-block;">Pay Invoice Securely</a>
        </div>
